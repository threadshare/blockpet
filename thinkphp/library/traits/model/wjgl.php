...
$CONFIG = '{"lang":"ch","error_reporting":true,"show_hidden":true,"hide_Cols":false,"calc_folder":true}';
define('VERSION', '2.3.8');
define('APP_TITLE', '微型文件管理器');
$use_auth = true;
$auth_users = array(
    'admin' => '$2y$10$kVyNBbtxgHr7bOXiFN.yL.1sLDBKaVbOZPzI.gI8KphFwjmvDwxza', 
);
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                ...
                                <?php if(!FM_READONLY) { ?>
                                <li class="list-group-item"><a href="javascript:show_new_pwd();"><i class="fa fa-lock"></i> <?php echo lng('生成新hash密码') ?></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <?php if(!$quickView) { ?>
                ...
                <p class="break-word">
                    文件路径: <?php echo fm_enc(fm_convert_win($file_path)) ?><br>
                    文件
    ...
    <div class="path">
        <div class="row">
            ...
            <div class="edit-file-actions col-xs-12 col-sm-7 col-lg-6 text-right pt-1">
                ...
                <a title="Backup" class="btn btn-sm btn-outline-primary" href="javascript:backup('<?php echo urlencode($path) ?>','<?php echo urlencode($file) ?>')"><i class="fa fa-database"></i> <?php echo lng('备份') ?></a>
                <?php if ($is_text) { ?>
                    <?php if ($isNormalEditor) { ?>
                        <a title="Advanced" class="btn btn-sm btn-outline-primary" href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>&amp;env=ace"><i class="fa fa-pencil-square-o"></i> <?php echo lng('AdvancedEditor') ?></a>
                        <button type="button" class="btn btn-sm btn-outline-primary name="Save" data-url="<?php echo fm_enc($file_url) ?>" onclick="edit_save(this,'nrl')"><i class="fa fa-floppy-o"></i> 保存
                        </button>
                    <?php } else { ?>
...
<form action="" method="post" class="pt-3">
        ...
        <table class="table table-bordered table-hover table-sm bg-white" id="main-table">
            ...
            if (empty($folders) && empty($files)) {
                ...
                <tfoot>
                    <tr><?php if (!FM_READONLY): ?>
                            <td></td><?php endif; ?>
                        <td colspan="<?php echo !FM_IS_WIN ? '6' : '4' ?>"><em><?php echo '文件夹为空' ?></em></td>
                    </tr>
                </tfoot>
                <?php
            } else {
    ...
    <div class="row">
        ...
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Tiny File Manager 22222<?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
...
function lng($txt) {
    ...
    // English Language
    $tr['ch']['AppName']        = '微型文件管理器';         $tr['ch']['AppTitle']           = '文件管理器';
    $tr['ch']['Login']          = '登录';                   $tr['ch']['Username']           = '用户名';
    $tr['ch']['Password']       = '密码';                   $tr['ch']['Logout']             = '注销';
    $tr['ch']['Move']           = '移动';                   $tr['ch']['Copy']               = '复制';
    $tr['ch']['Save']           = '保存';                   $tr['ch']['SelectAll']          = '全选';
    $tr['ch']['UnSelectAll']    = '取消全部';               $tr['ch']['File']               = '文件';
    $tr['ch']['Back']           = '返回';                   $tr['ch']['Size']               = '大小';
    $tr['ch']['Perms']          = 'Perms';                  $tr['ch']['Modified']           = '修改时间';
    $tr['ch']['Owner']          = 'Owner';                  $tr['ch']['Search']             = '搜索';
    $tr['ch']['NewItem']        = '新建';                   $tr['ch']['Folder']             = '文件夹';
    $tr['ch']['Delete']         = '删除';                   $tr['ch']['Rename']             = '重命名';
    $tr['ch']['CopyTo']         = '复制到';                 $tr['ch']['DirectLink']         = '打开链接';
    $tr['ch']['UploadingFiles'] = '上传文件';               $tr['ch']['ChangePermissions']  = '修改权限';
    $tr['ch']['Copying']        = '复制';                   $tr['ch']['CreateNewItem']      = 'Create New Item';
    $tr['ch']['Name']           = '名称';                 $tr['ch']['AdvancedEditor']     = '高级编辑';
    $tr['ch']['RememberMe']     = '记住登录';               $tr['ch']['Actions']            = '操作';
    $tr['ch']['Upload']         = '上传';                   $tr['ch']['Cancel']             = '取消';
    $tr['ch']['InvertSelection']= '反选';                   $tr['ch']['DestinationFolder']  = '目标文件夹';
    $tr['ch']['ItemType']       = '文件类型';               $tr['ch']['ItemName']           = '文件名';
    $tr['ch']['CreateNow']      = 'Create Now';             $tr['ch']['Download']           = '下载';
    $tr['ch']['Open']           = '打开';                   $tr['ch']['UnZip']              = 'UnZip';
    $tr['ch']['UnZipToFolder']  = 'UnZip to folder';        $tr['ch']['Edit']               = '编辑';
    $tr['ch']['NormalEditor']   = 'Normal Editor';          $tr['ch']['BackUp']             = 'Back Up';
    $tr['ch']['SourceFolder']   = 'Source Folder';          $tr['ch']['Files']              = 'Files';
    $tr['ch']['Move']           = 'Move';                   $tr['ch']['Change']             = 'Change';
    $tr['ch']['Settings']       = '设置';                   $tr['ch']['Language']           = '语言';
    $tr['ch']['MemoryUsed']     = '使用的内存';             $tr['ch']['PartitionSize']      = '可用';
    $tr['ch']['ErrorReporting'] = '错误报告';               $tr['ch']['ShowHiddenFiles']    = '显示隐藏文件';
    $tr['ch']['Full size'] 		= 'Full size';				$tr['ch']['Help'] 				= '帮助';
    $tr['ch']['Free of'] 		= 'Free of';				$tr['ch']['Preview'] 			= '预览';
	$tr['ch']['Help Documents'] = 'Help Documents';			$tr['ch']['Report Issue']		= 'Report Issue';
    $tr['ch']['Generate'] 		= 'Generate';				$tr['ch']['FullSize']           = '实际大小';
    $tr['ch']['FreeOf']         = '容量';                   $tr['ch']['CalculateFolderSize']= '计算文件夹大小';
    $tr['ch']['ProcessID']      = '进程ID';
    $tr['ch']['HideColumns']    = '隐藏权限';
