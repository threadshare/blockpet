<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./themes/admin/wealth\wechat_service.html";i:1581060100;s:50:"D:\phpStudy\PHPTutorial\WWW\themes\admin\base.html";i:1581060100;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('editRecharge'); ?>">微信充值二维码</a></li>
            <li class="layui-this">支付宝</li>
            <li class=""><a href="<?php echo url('qqService'); ?>">客服</a></li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('editRecharge'); ?>" method="post">

                    <div class="layui-form-item">
                        <label class="layui-form-label">支付宝账号</label>
                        <div class="layui-input-block">
                            <input type="text" name="account" value="<?php echo $info['alipay_account']; ?>" class="layui-input layui-input-inline" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <img src="<?php echo $info['alipay_img']; ?>"  id="thumb2">
                            <input type="hidden" name="img" value="<?php echo $info['alipay_img']; ?>" class="layui-input layui-input-inline" id="thumb">
                            <br/>
