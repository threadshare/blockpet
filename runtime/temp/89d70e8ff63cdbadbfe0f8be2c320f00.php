<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./themes/admin/wealth\edit_recharge.html";i:1581060100;s:50:"D:\phpStudy\PHPTutorial\WWW\themes\admin\base.html";i:1581060100;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li class="layui-this">微信充值二维码</li>
            <li class=""><a href="<?php echo url('wechatService'); ?>">支付宝二维码</a></li>
                ...
                <form class="layui-form form-container" action="<?php echo url('editRecharge'); ?>" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="account" value="<?php echo $info['wechat_account']; ?>" class="layui-input layui-input-inline">

                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">微信充值二维码</label>
                        <div class="layui-input-block">
                            <img src="<?php echo $info['wechat_img']; ?>" id="thumb2">
                            <input type="hidden" name="img" value="<?php echo $info['wechat_img']; ?>" class="layui-input layui-input-inline" id="thumb">
                            <br/>
